...
DynamoDb.prototype.getItem = function (params, callback) {
    ...
    /*
    if (this.transform) {
        params.Key = self.transform.from(params.TableName, params.Key);
    }
    */
...
DynamoDb.prototype.deleteItem = function (params, callback) {
    ...
    //TODO fix transform in this case
    if (this.transform) {
        params.Key = self.transform.to(params.TableName, params.Key);
    }
    ...
    return bindCallback(
        nodefn.call((this.client.deleteItem).bind(this.client), params)
            .then(function (data) {
                ...
                if (data && self.transform) {
                    data.Attributes = self.transform.from(params.TableName, data.Attributes);
                }
...
DynamoDb.prototype.updateItem = function (params, callback) {
    ...
    if (this.transform) {
        params.Key = transform.to(params.TableName, params.Key);
    }
...
DynamoDb.prototype.batchWriteItem = function (params) {

    var self = this;

    if (this.transform) {
        Object.keys(params.RequestItems).forEach(function (table) {
            params.RequestItems[table].forEach(function (request, i) {

                if (request.DeleteRequest) {
                    params.RequestItems[table][i].DeleteRequest.Key = self.transform.to(table, request.DeleteRequest.Key);
                }

                if (request.PutRequest) {
                    params.RequestItems[table][i].PutRequest.Item = self.transform.to(table, request.PutRequest.Item);
                }
            });
        });
    }

    return nodefn.call((this.client.batchWriteItem).bind(this.client), params);
};

DynamoDb.prototype.batchGetItem = function (params) {
    var self = this;

    if (this.transform) {
        Object.keys(params.RequestItems).forEach(function (table) {
            params.RequestItems[table].Keys.forEach(function (key, i) {
                params.RequestItems[table].Keys[i].Key = self.transform.to(table, key);
            });
        });
    }

    return nodefn.call((this.client.batchGetItem).bind(this.client), params)
        .then(function (items) {
...
DynamoDb.prototype.query = function (params) {
    ...
    return nodefn.call((this.client.query).bind(this.client), params)
        .then(function (items) {
...
DynamoDb.prototype.scan = function (params) {
    ...
    return nodefn.call((this.client.scan).bind(this.client), params)
        .then(function (items) {
...
DynamoDb.prototype.queryStream = function (params) {
    return new streams.Query(this.client, params, this.transform);
};
...
DynamoDb.prototype.scanStream = function (params) {
    return new streams.Scan(this.client, params, this.transform);
};
