            ...
            function iterate(o) {
                ...
                if (o instanceof Object) {
                    ...
                    for (var key in o) {
                        ...
                        if (schema[key] == "SS")    payload[key] = {
                            "SS": o[key].map(function (e) {
                                return String(e);
                            })
                        };
                        if (schema[key] == "N")    payload[key] = {"N": String(o[key])};
                        if (schema[key] == "NS")    payload[key] = {
                            "NS": o[key].map(function (e) {
                                return String(e);
                            })
                        };
                        if (schema[key] == "B")    payload[key] = {"B": o[key].toString("base64")};
                        if (schema[key] == "BS")    payload[key] = {
                            "BS": o[key].map(function (e) {
            ...
            function iterate(o) {
                ...
                if (o instanceof Object) {
                    ...
                    for (var key in o) {
                        ...
                        if (o[key] && o[key]["SS"]) payload[key] = o[key]["SS"].map(function (e) {
                            return String(e);
                        });
                        if (o[key] && o[key]["N"]) payload[key] = Number(o[key]["N"]);
                        if (o[key] && o[key]["NS"]) payload[key] = o[key]["NS"].map(function (e) {
                            return Number(e);
                        });
                        if (o[key] && o[key]["B"]) payload[key] = new Buffer(o[key]["B"], "base64");
                        if (o[key] && o[key]["BS"]) payload[key] = o[key]["BS"].map(function (e) {
